...
# Usage: .\archive.ps1 -ProjectTitle "Your Project Name"
# MCP COMMAND EXAMPLE: run archive.ps1 --ProjectTitle "My Project Name"
...
$SourceFiles = Get-ChildItem -Path . -File | Where-Object { $_.Name -ne "archive.ps1" -and $_.Name -ne "archive.sh" -and $_.Name -ne "cursor.md" -and $_.Name -ne "cleanup.ps1" -and $_.Name -ne "cleanup.sh" -and $_.Name -ne "ARCHIVE_SCRIPT_DEVELOPMENT_REPORT.md" -and $_.Name -ne "PROJECT_COMPLETION_REPORT.md" } | ForEach-Object { $_.Name }
...
$SummaryLines = @(
    ...
    "- **Script Used**: Enhanced archive.ps1",
    "",
    "## Project Overview",
...
$SummaryLines += @(
    ...
    "",
    "---",
    "*Archived by Enhanced PowerShell script: archive.ps1*",
...
$ReadmeLines = @(
    ...
    "",
    "---",
    "*This README was automatically generated by archive.ps1*"
)
...
if ($ArchivedFiles.Count -eq $SourceFiles.Count) {
    ...
    Write-Host "cursor.md and archive.ps1 remain in the workspace." -ForegroundColor Green
